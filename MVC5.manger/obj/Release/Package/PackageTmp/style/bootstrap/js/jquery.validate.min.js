	...
	return $(selector).validate({
		...
		errorPlacement: function (error, element) {
			if(""!=error.html()&&element.parent().parent().find("em").html()==""){
				element.parent().find("#err").html("<span style=\"width: 40%;color: red;\"><img src=\""+projectName+"/asserts/image/error.png\"/>"+error.html()+"</span>");
			}else if(""!=error.html()&&element.parent().parent().find("em").html()!=""){
				element.parent().find("#err").html("");
				element.parent().find("#err").html("<span style=\"width: 40%;color: red;\"><img src=\""+projectName+"/asserts/image/error.png\"/>"+error.html()+"</span>");
			}else if(""==error.html()&&element.parent().parent().find("em").html()==""){
				element.parent().find("#err").html("<span style=\"width: 40%;color: green;\"><img src=\""+projectName+"/asserts/image/right_1.png\"/>验证成功</span>");
			}else if(""==error.html()&&element.parent().parent().find("em").html()!=""){
				element.parent().find("#err").html("");
				element.parent().find("#err").html("<span style=\"width: 40%;color: green;\"><img src=\""+projectName+"/asserts/image/right_1.png\"/>验证成功</span>");
			}
 ...
 * 自定义 整数范围
 */
jQuery.validator.addMethod("integerRange", function(value, element, param) {
	return (value === "1" || value === "2")
}, $.validator.format("请输入整数1或整数2"));
/**
 * 结束时间不能小于开始时间验证
 * */
